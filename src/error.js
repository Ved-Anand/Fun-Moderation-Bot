...
const nodeMajorVersion = parseInt(process.versions.node.split('.')[0, 14]); 


if (nodeMajorVersion < 16) { 
    logger.warn('This is an unsupported NODE.JS version. Please install and use NODE.JS 16 or newer');
    process.exit(1);
}
