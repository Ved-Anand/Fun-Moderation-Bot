...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (checkCody.toLowerCase() == "cody") return message.channel.send("Cody: The most highly annoying person you'll ever meet. His name after all, literally means annoying. He is a pure menace. Whenever you find a cody, be sure to stay away from them.");
